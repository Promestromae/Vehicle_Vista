...
from .models import User, Car, CarPrice
...
class AppTestCase(unittest.TestCase):
        ...
        self.admin = Admin(self.app, name='Vehicle Vista Dashboard', template_mode='bootstrap3')
    ...
    def test_create_app_admin(self):
                self.assertEqual(self.admin.name, 'Vehicle Vista Dashboard')
